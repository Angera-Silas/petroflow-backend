...
public class EmployeeController {
    ...
    @GetMapping("/organization/{organizationId}/facility/{facilityId}")
    public ResponseEntity<List<EmployeeDetailsDto>> getEmployeesByOrganizationIdAndFacilityId(
            @PathVariable Long organizationId,
            @PathVariable Long facilityId) {
        List<EmployeeDetailsDto> employees = employeeService.getEmployeesByOrganizationIdAndFacilityId(organizationId, facilityId);
        return ResponseEntity.ok(employees);
    }
    ...
    public ResponseEntity<List<EmployeeDetailsDto>> getEmployeesWithOrganizationAndFacilityNames(@PathVariable Long organizationId) {
        List<EmployeeDetailsDto> employees = employeeService.getEmployeesWithOrganizationAndFacilityNames(organizationId);
        return ResponseEntity.ok(employees);
    }
